...
The MIN_DURATION is somewhat arbitrary. I decided that, for practical purposes, if I try to make a note shorter than a 1/128th note, it's duration will be 1/128. I used a MIN_DURATION constant so that this value can be easily changed in one place. Change it if you want.
